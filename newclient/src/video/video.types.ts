...
type GetAllVideosType = GetAllVideosLoading | GetAllVideosSuccess | GetAllVideosFail;
...
type GetVideoByIdType = GetVideoByIdLoading | GetVideoByIdSuccess | GetVideoByIdFail;
...
type CreateVideoType = CreateVideoAsyncLoading | CreateVideoAsyncSuccess | CreateVideoAsyncFail;

export type VideoActionsTypes = GetAllVideosType | GetVideoByIdType | CreateVideoType;